...
export const TrackOrderPage: React.FC = () => {
  ...
  if (!isLoaded || authLoading) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-[#F4EBDB]/30 to-white">
        <div className="w-[40px] h-[40px] border-4 border-[#254936] border-t-transparent rounded-full animate-spin"></div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-gradient-to-b from-[#F4EBDB]/40 to-white min-h-screen pt-[120px] pb-[80px] font-sans">
      <div className="max-w-[1200px] mx-auto px-[24px]">
        ...
        {!loggedIn ? (
          <div className="max-w-[500px] mx-auto bg-white border border-[#E0D4BE] rounded-[24px] md:rounded-[32px] p-[24px] md:p-[40px] text-center shadow-sm">
            <div className="w-[48px] md:w-[64px] h-[48px] md:h-[64px] bg-[#f5f5f5] rounded-full flex items-center justify-center mx-auto text-[#254936] mb-[16px] md:mb-[24px]">
              <Lock className="w-[20px] md:w-[24px] h-[20px] md:h-[24px]" />
            </div>
            <h3 className="font-playfair text-[20px] md:text-[24px] font-bold text-[#254936] mb-[8px] md:mb-[12px]">Sign In Required</h3>
            <p className="text-[13px] md:text-[14px] text-[#63786A] leading-relaxed font-light mb-[24px] md:mb-[32px]">
            ...
            <button
              ...
              className="w-full py-[14px] md:py-[16px] bg-[#254936] hover:bg-[#B69355] text-white text-[12px] font-bold uppercase tracking-widest transition-colors rounded-full"
            >
          ...
          <div className="flex flex-col lg:flex-row gap-[24px] md:gap-[40px]">
            ...
            <div className="w-full lg:w-[400px] shrink-0 space-y-[24px] md:space-y-[32px]">
              <div className="bg-white border border-[#E0D4BE] rounded-[24px] md:rounded-[32px] p-[20px] md:p-[32px] shadow-sm">
                <h3 className="font-playfair text-[18px] md:text-[20px] font-bold text-[#254936] mb-[16px] md:mb-[24px]">
                  Search Order
                </h3>
                <form onSubmit={handleTrackSubmit} className="space-y-[12px] md:space-y-[16px]">
                  <div className="relative">
                    <input
                      ...
                      className="w-full pl-[40px] md:pl-[48px] pr-[12px] md:pr-[16px] py-[12px] md:py-[16px] bg-[#f5f5f5] border border-transparent focus:border-[#B69355] focus:bg-white rounded-xl text-[13px] md:text-[14px] outline-none transition-all"
                    />
                    <Package className="w-[18px] md:w-[20px] h-[18px] md:h-[20px] text-[#63786A] absolute left-[12px] md:left-[16px] top-1/2 -translate-y-1/2 pointer-events-none" />
                  </div>
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full bg-[#254936] hover:bg-[#B69355] text-white text-[11px] md:text-[12px] font-bold px-[20px] md:px-[24px] py-[12px] md:py-[16px] rounded-xl uppercase tracking-widest transition-colors cursor-pointer flex items-center justify-center gap-[6px] md:gap-[8px]"
                  >
                    {isLoading ? (
                ...
                <div className="bg-white border border-[#E0D4BE] rounded-[24px] md:rounded-[32px] p-[20px] md:p-[32px] shadow-sm">
                  ...
                  <div className="space-y-[12px] md:space-y-[16px]">
                    {userOrders.slice(0, 3).map((order: any) => (
                      <div key={order.id} className="p-[12px] md:p-[16px] border border-[#E0D4BE] rounded-xl hover:border-[#254936] transition-colors group cursor-pointer" onClick={() => triggerTrackOrder(order.order_number)}>
                        <div className="flex justify-between items-center mb-[4px] md:mb-[8px]">
                          <span className="font-mono text-[13px] md:text-[14px] font-bold text-[#254936]">{order.order_number}</span>
                          <ChevronRight className="w-[14px] md:w-[16px] h-[14px] md:h-[16px] text-[#63786A] group-hover:text-[#254936] transition-colors" />
                        </div>
                        <p className="text-[11px] md:text-[12px] text-[#63786A]">
            ...
            <div className="w-full flex-1">
              {searched && (
                <AnimatePresence mode="wait">
                  <motion.div
                    ...
                    className="bg-white border border-[#E0D4BE] rounded-[24px] md:rounded-[32px] p-[24px] md:p-[48px] shadow-sm min-h-[400px] md:min-h-[500px]"
                  >
                    {trackResult ? (
                      <div>
                        {/* Status Header */}
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-[16px] md:gap-[24px] mb-[24px] md:mb-[40px] pb-[24px] md:pb-[32px] border-b border-[#E0D4BE]">
                          <div>
                            <span className="text-[11px] md:text-[12px] font-bold text-[#63786A] uppercase tracking-wider block mb-[4px] md:mb-[8px]">
                            ...
                            <p className="text-[13px] md:text-[14px] text-[#63786A] mt-[4px] md:mt-[8px]">
                              Estimated Delivery: <strong className="text-[#254936]">{trackResult.estimatedDelivery}</strong>
                            </p>
                          </div>
                          <div className="bg-[#f5f5f5] p-[12px] md:p-[16px] rounded-xl text-[11px] md:text-[12px]">
                            <p className="text-[#63786A] mb-[2px] md:mb-[4px]">Shipping to:</p>
                            <p className="font-bold text-[#254936]">{trackResult.fullName}</p>
                            <p className="text-[#63786A]">{trackResult.address}</p>
                          </div>
                        </div>
                              ...
                              return (
                                <div key={idx} className="relative flex items-start gap-[16px] md:gap-[24px]">
                                  <div className="relative z-10 w-[24px] h-[24px] mt-[2px] shrink-0">
                                    {status === "completed" ? (
                                      <div className="w-full h-full rounded-full bg-[#254936] flex items-center justify-center">
                                        <CheckCircle className="w-[12px] h-[12px] text-white" />
                                      </div>
                                    ) : status === "active" ? (
                                      <div className="w-full h-full rounded-full border-[4px] border-[#B69355] bg-white shadow-[0_0_0_4px_rgba(201,162,39,0.1)]" />
                                    ) : (
                                      <div className="w-full h-full rounded-full border-2 border-[#E0D4BE] bg-white" />
                                    )}
                                  </div>
                                  <div>
                                    <h4 className={`text-[15px] md:text-[16px] font-bold mb-[2px] md:mb-[4px] ${
                                      status === "completed" ? "text-[#254936]" : status === "active" ? "text-[#B69355]" : "text-[#63786A]"
                                    }`}>
                                      {stage.title}
                                    </h4>
                                    <p className="text-[13px] md:text-[14px] text-[#63786A] font-light max-w-[400px]">
                                      {stage.desc}
                                    </p>
                                  </div>
                                </div>
                      ...
                      <div className="h-full flex flex-col items-center justify-center text-center py-[60px] md:py-[80px]">
                        <div className="w-[64px] md:w-[80px] h-[64px] md:h-[80px] bg-[#f5f5f5] rounded-full flex items-center justify-center mb-[16px] md:mb-[24px]">
                          <ShieldAlert className="w-[24px] md:w-[32px] h-[24px] md:h-[32px] text-[#B69355]" />
                        </div>
                        <h3 className="font-playfair text-[20px] md:text-[24px] font-bold text-[#254936] mb-[8px] md:mb-[12px]">
                          Order Not Found
                        </h3>
                        <p className="text-[13px] md:text-[14px] text-[#63786A] max-w-[400px]">
              ...
              {!searched && (
                <div className="bg-white/50 border border-[#E0D4BE] rounded-[24px] md:rounded-[32px] h-full min-h-[400px] md:min-h-[500px] flex flex-col items-center justify-center text-center p-[24px] md:p-[40px]">
                  <div className="w-[64px] md:w-[80px] h-[64px] md:h-[80px] bg-white rounded-full flex items-center justify-center shadow-sm mb-[16px] md:mb-[24px]">
                    <Package className="w-[24px] md:w-[32px] h-[24px] md:h-[32px] text-[#B69355]" />
                  </div>
                  <h3 className="font-playfair text-[20px] md:text-[24px] font-bold text-[#254936] mb-[8px] md:mb-[12px]">
                    Track Your Package
                  </h3>
                  <p className="text-[13px] md:text-[14px] text-[#63786A] max-w-[300px]">
