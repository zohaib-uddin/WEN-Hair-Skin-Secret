  ...
  return (
    <div className="pt-[140px] pb-[80px] bg-gradient-to-b from-[#F4EBDB]/40 to-white min-h-screen">
      <div className="max-w-[800px] mx-auto px-6 bg-white p-10 rounded-2xl shadow-sm">
        <h1 className="text-4xl font-playfair font-bold text-[#254936] mb-8">Privacy Policy</h1>
        <div className="prose prose-sm md:prose-base text-gray-700">
          ...
          <h2 className="text-xl font-bold mt-8 mb-4 text-[#254936]">Information We Collect</h2>
          ...
          <h2 className="text-xl font-bold mt-8 mb-4 text-[#254936]">How We Use Your Information</h2>
