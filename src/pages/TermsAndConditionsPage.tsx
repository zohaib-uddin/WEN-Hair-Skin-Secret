  ...
  return (
    <div className="pt-[140px] pb-[80px] bg-[#f9f9f9] min-h-screen">
      <div className="max-w-[800px] mx-auto px-6 bg-white p-10 rounded-2xl shadow-sm">
        <h1 className="text-4xl font-playfair font-bold text-[#1F4D3A] mb-8">Terms and Conditions</h1>
        <div className="prose prose-sm md:prose-base text-gray-700">
          ...
          <h2 className="text-xl font-bold mt-8 mb-4 text-[#1a1a1a]">Conditions of Use</h2>
          ...
          <h2 className="text-xl font-bold mt-8 mb-4 text-[#1a1a1a]">Intellectual Property</h2>
