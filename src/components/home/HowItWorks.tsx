    ...
    <section className="py-[32px] md:py-[60px] lg:py-[80px] bg-white font-sans overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-[16px] md:px-[24px]">
        ...
        >
          ...
          <h2 className="font-playfair text-[20px] md:text-[36px] font-bold text-[#254936] tracking-[-0.01em]">
            Your Daily Routine
          </h2>
          <p className="text-[11px] md:text-[14px] text-[#63786A] leading-[1.6] mt-[6px] md:mt-[10px] max-w-[400px]">
        ...
        <div className="relative group">
          ...
          <div className="hidden md:block absolute top-[20px] left-[15%] right-[15%] h-[2px] border-t-2 border-dashed border-[#B69355]/30 -z-10" />
          <div 
          ...
          >
            {steps.map((step, idx) => (
              ...
              >
                <div className="w-[36px] md:w-[40px] h-[36px] md:h-[40px] rounded-full bg-[#B69355] flex items-center justify-center font-sans font-bold text-white text-[14px] md:text-[16px] mb-[12px] shadow-sm ring-4 ring-white">
                  {step.number}
                </div>
                <div className="w-[48px] h-[48px] rounded-full bg-[#F4EBDB] flex items-center justify-center mb-[12px]">
                  {step.icon}
                </div>
                <h3 className="font-playfair text-[16px] md:text-[18px] font-bold text-[#254936] mb-[6px]">
                  {step.title}
                </h3>
                <p className="text-[#63786A] text-[11px] md:text-[12px] leading-[1.6] max-w-[240px]">
                  {step.desc}
                </p>
              </motion.div>
            ))}
