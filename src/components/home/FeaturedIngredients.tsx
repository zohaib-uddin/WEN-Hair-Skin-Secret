    ...
    <section className="py-[40px] md:py-[80px] lg:py-[120px] bg-white font-sans overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-[16px] md:px-[24px]">
        ...
        >
          ...
          <span className="text-[#B69355] text-[9px] md:text-[11px] font-bold tracking-[3px] uppercase block mb-[12px] md:mb-[16px]">
            98% Natural Actives
          </span>
          <h2 className="font-playfair text-[24px] md:text-[44px] font-bold text-[#254936] tracking-[-0.01em]">
            Formulated Botanicals
          </h2>
          <p className="text-[12px] md:text-[15px] text-[#63786A] leading-[1.6] md:leading-[1.7] mt-[8px] md:mt-[12px] max-w-[500px]">
        ...
        >
          {ingredients.map((ing, idx) => (
            ...
            >
              <div className="w-[80px] h-[80px] rounded-full bg-[#F4EBDB] flex items-center justify-center mb-[20px] overflow-hidden p-[2px]">
                <img
                  src={ing.image}
                  alt={ing.name}
              ...
              <h3 className="font-playfair text-[18px] font-bold text-[#254936] mb-[4px]">
                {ing.name}
              </h3>
              <span className="text-[#B69355] text-[10px] tracking-[1px] uppercase font-bold block mb-[12px]">
                {ing.tagline}
              </span>
              <p className="text-[13px] text-[#63786A] leading-[1.7]">
                {ing.description}
              </p>
            </motion.div>
          ))}
